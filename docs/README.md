...
| **8** | [phase8_plan.md](phase8_plan.md) | 多平台 runtime 方向规划（8b+ 预告） |
...
| **接第二平台前** | 在真实 PDD 测试店跑通 [phase0_audit.md](phase0_audit.md) 黄金路径；8a Demo runtime 已验骨架，下一步 **8b** outbound 泛化或真实平台 spike |
